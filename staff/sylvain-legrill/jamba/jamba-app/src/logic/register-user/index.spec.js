...
describe('logic - register user', () => {
    let name, surname, email, phone, password, role, city, license, specialty
    ...
    it('should succeed on correct data', async () => {
        const response = await registerUser(name, surname, email, phone, password, role, city, license, specialty)
