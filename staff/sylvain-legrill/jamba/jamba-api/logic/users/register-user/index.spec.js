...
describe('logic - register user', () => {
    ...
    let name, surname, email, phone, password, city, license, specialty, profileImg, portfolioUrl, projectImg, description
    ...
    it('should succeed on correct architect data', async () =>{
        const result = await registerUser(name, surname, email, phone, password, "architect", city, license, specialty, profileImg, portfolioUrl, projectImg, description)
    ...
    it('should fail if the mail already exists', async () => {
        await User.create({ name, surname, email, phone, password, city, license, specialty, profileImg, portfolioUrl, projectImg, description })
            try{
                await registerUser(name, surname, email, phone, password, city, license, specialty, profileImg, portfolioUrl, projectImg, description )
    ...
    it('should fail on empty email', () =>
        expect(() => registerUser(name, surname, "123@mailcom", phone, password, city, license, specialty, profileImg, portfolioUrl, projectImg, description)).to.throw('e-mail with value 123@mailcom is not a valid e-mail')
    )
