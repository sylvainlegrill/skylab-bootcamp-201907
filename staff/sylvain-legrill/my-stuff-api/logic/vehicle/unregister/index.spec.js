...
describe.only('logic unregister vehicle', () => {
    ...
    //////////////////
        ...
        it('should fail if the id is not a string', () => expect(() => logic.vehicle.unregister(12345678).to.throw("id with value '12345678' is not a string")))
        it('should fail if the id is empty or blank', () => expect(() => logic.vehicle.unregister().to.throw("id is empty or blank")))
