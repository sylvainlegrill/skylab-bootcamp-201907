...
describe('logic - retrieve card', () => {
    ...
    beforeEach(() => {
        ...
        return User.deleteMany()
            ...
            .then(user =>{
                ...
                return user.save() //retornes l'usuari guardat
            })            
    })
    ...
    it('should fail if there is no user', () => {
            logic.card.retrieve("5e624a1e0e56cb055f56d3d0", cardId)
               .catch( error =>{
                debugger
    ...
    it('should fail on empty number', () => {
        expect(() =>
            logic.card.retrieve("", number)
        ).to.throw('id is empty or blank')
    })

    it('should fail on undefined number', () => {
        expect(() =>
            logic.card.retrieve(undefined, number)
        ).to.throw(`id with value undefined is not a string`)
    })

    it('should fail on wrong data type', () => {
        expect(() =>
            logic.card.retrieve(123, number )
